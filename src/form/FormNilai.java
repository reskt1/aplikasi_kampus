...
//    }
    ...
    public void tampilData() {
        try {
            ...
            while (rs.next()) {
                ...
                CBIdM.setSelectedItem(rs.getString("id_mengajar"));
    ...
    public void addData() {
        try {
            int idMengajar = Integer.parseInt(CBIdM.getSelectedItem().toString());
    ...
    public void updateData() {
        try {
            ...
            ps.setString(2, CBIdM.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormNilai dialog = new FormNilai();
